...
@section('subtitle', 'DEPARTMENT ADD')
@section('content_header_title', 'DEPARTMENTS')
@section('content_header_subtitle', 'DEPARTMENT ADD')
    ...
    {{ html()->form('POST', route('department.store'))->open() }}
        <div class="card">
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">DEPARTMENT ADD</strong>
                    </div>
            ...
            <div class="card-footer text-right">
                {{ html()->submit('<i class="fa fa-save"></i> SAVE DEPARTMENT')->class(['btn', 'btn-primary', 'btn-sm']) }}
            </div>
        </div>
    {{ html()->form()->close() }}
@stop
