...
@section('subtitle', 'DEVICE EDIT')
@section('content_header_title', 'DEVICES')
@section('content_header_subtitle', 'DEVICE EDIT')

{{-- Content body: main page content --}}
@section('content_body')
    {{ html()->form('POST', route('device.update', encrypt($device->id)))->open() }}
        <div class="card">
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">DEVICE EDIT</strong>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {{ html()->input('text', 'prefix', $device->prefix)->placeholder('Prefix')->class(['form-control', 'form-control-sm', 'is-invalid' => $errors->has('prefix')]); }}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {{ html()->input('text', 'name', $device->name)->placeholder('Name')->class(['form-control', 'form-control-sm', 'is-invalid' => $errors->has('name')]); }}
