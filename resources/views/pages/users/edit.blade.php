        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            {{ html()->label('BIRTHDATE', 'birthdate')->class(['mb-0']) }}
                            {{ html()->input('date', 'birthdate', $user->birthdate)->placeholder('Birthdate')->class(['form-control', 'form-control-sm', 'is-invalid' => $errors->has('birthdate')]); }}
